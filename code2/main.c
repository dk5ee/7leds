 ...
 *     License: MIT
 *
 *  This code for software pwm is inspired by delta-sigma modulation
 *  https://www.embeddedrelated.com/showarticle/107.php
 *  Variant: "synthetic division" by Eric Jensen 
 *
 ...
 *  different times
 *  B) instead of normal PWM, the "synthetic division" algo is 
 *  implemented. This behaves similar to first-order delta-sigma 
 *  modulation
 *
 *  Interface:
 *  1. connect via uart
